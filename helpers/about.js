...
var About = function(Discord, client) {
    ...
    this.verification = (msg, config, cb) => {
    	...
    	embed.addField("1", "all new joiners will need to visit an external verification page to be allowed in, which requires that they have **1 connected account.**")
    	embed.addField("2, 3, 4", "the same as **1**, except you must connect **2** accounts, etc. etc.")
